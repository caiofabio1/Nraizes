...
class ProductEnricher:
    ...
    def enrich_product(self, product: Dict[str, Any]) -> Dict[str, Any]:
        ...
        descricao_atual = product.get('descricaoCurta', '') or product.get('descricaoComplementar', '')
...
class SEOValidator:
    ...
    def has_call_to_action(text: str) -> bool:
        ...
        cta_patterns = [
            r'compre', r'confira', r'descubra', r'experimente',
            r'aproveite', r'garanta', r'adquira', r'saiba mais',
            r'clique', r'veja', r'conheça'
        ]
